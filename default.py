...
def triage(mode, params, path, arguments, itemid):
    ...
    try:
        if mode == "browseplex":
        ...
        elif mode == "discover_hubs":
            entrypoint.discover_hubs()
        elif mode == "discover_hub":
            entrypoint.discover_hub(params.get("hub_id"))
        elif mode == "channels":
            ...
            entrypoint.browse_plex(
                key="/hubs/search",
                args={"includeCollections": 1, "includeExternalMedia": 1},
        ...
        elif "/Extras" in path or "/VideoFiles" in path or "/Extras" in arguments:
